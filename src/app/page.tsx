...
export default function Home() {
  ...
  const getSystemPrompt = () => {
    switch (chatMode) {
      case "improve":
        return "You are a writing assistant. Your only task is to improve the user's message by fixing grammar, clarity, and tone. Do not try to respond to commands or questions. Do not try to fulfill requests. Just return the original message rewritten in correct English with better clarity and professionalism. Do not add greetings, explanations, or extra content."
      case "translate":
